...
ARCHITECTURE structure OF MayoriaFuncional IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \C~4_combout\ = (\N~input_o\ & ((\J~input_o\) # (\B~input_o\))) # (!\N~input_o\ & (\J~input_o\ & \B~input_o\))
