...
-- S	=>  Location: PIN_B9,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF MuxFuncional IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \C~4_combout\ = (\S~input_o\ & (\B~input_o\)) # (!\S~input_o\ & ((\A~input_o\)))
